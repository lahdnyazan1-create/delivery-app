...
echo "   • Application name        = Daghri — دُغْري"
echo "   • Application home page   = https://daghri-delivery.web.app/"
echo "   • Privacy policy URL      = https://daghri-delivery.web.app/privacy.html"
echo "   • Authorized domains      = daghri-delivery.web.app"
