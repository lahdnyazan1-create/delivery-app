...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6 text-center text-foreground">
      <div className="glass tatreez w-full max-w-md space-y-6 rounded-3xl p-8">
        ...
        <h1 className="text-2xl font-bold text-primary">أهلاً بك في دُغْري</h1>
        <p className="text-sm leading-relaxed text-foreground-muted">
          توصيل أسرع وأسهل… دُغْري! اطلب وجباتك المفضلة من أفضل المطاعم
          المحلية مع تتبع مباشر وحالة الطلب خطوة بخطوة.
        </p>
        <button
          type="button"
